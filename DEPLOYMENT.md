...
4. Configure:
   ...
   - **Build Command**: 
     ```
     cd c_engine && gcc -o recommender recommender.c -lm && gcc -o movie_system system_main.c auth.c comments.c chat.c mylist.c friends.c utils.c -lm && cd .. && pip install -r requirements.txt
     ```
